...
const slideComponents = {
  ...
  SlideClosing1: lazy(() => import('./slides/SlideClosing1')),
  SlideClosing2: lazy(() => import('./slides/SlideClosing2')),
  SlideClosing3: lazy(() => import('./slides/SlideClosing3')),
  SlideClosing4: lazy(() => import('./slides/SlideClosing4')),
