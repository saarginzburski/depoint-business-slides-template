...
const slideComponents = {
  ...
  SlideProblemStats: lazy(() => import('./slides/SlideProblemStats').catch(() => ({ default: () => <div className="w-full h-full bg-slate-900 flex items-center justify-center"><div className="text-white/20 text-6xl font-bold">25</div></div> }))),
  ...
  SlideSolutionOverview: lazy(() => import('./slides/SlideSolutionOverview').catch(() => ({ default: () => <div className="w-full h-full bg-slate-900 flex items-center justify-center"><div className="text-white/20 text-6xl font-bold">4</div></div> }))),
  SlideDigitizingOpsManual: lazy(() => import('./slides/SlideDigitizingOpsManual').catch(() => ({ default: () => <div className="w-full h-full bg-slate-900 flex items-center justify-center"><div className="text-white/20 text-6xl font-bold">5</div></div> }))),
  ...
  SlideGlobalBrands: lazy(() => import('./slides/SlideGlobalBrands').catch(() => ({ default: () => <div className="w-full h-full bg-slate-900 flex items-center justify-center"><div className="text-white/20 text-6xl font-bold">15</div></div> }))),
  SlideFieldAssociates: lazy(() => import('./slides/SlideFieldAssociates').catch(() => ({ default: () => <div className="w-full h-full bg-slate-900 flex items-center justify-center"><div className="text-white/20 text-6xl font-bold">16</div></div> }))),
  ...
  SlideDashboardFeatures: lazy(() => import('./slides/SlideDashboardFeatures').catch(() => ({ default: () => <div className="w-full h-full bg-slate-900 flex items-center justify-center"><div className="text-white/20 text-6xl font-bold">27</div></div> }))),
  Slide360Management: lazy(() => import('./slides/Slide360Management').catch(() => ({ default: () => <div className="w-full h-full bg-slate-900 flex items-center justify-center"><div className="text-white/20 text-6xl font-bold">28</div></div> }))),
  SlideOutOfTheBox: lazy(() => import('./slides/SlideOutOfTheBox').catch(() => ({ default: () => <div className="w-full h-full bg-slate-900 flex items-center justify-center"><div className="text-white/20 text-6xl font-bold">29</div></div> }))),
  SlideAnalyticsPlatform: lazy(() => import('./slides/SlideAnalyticsPlatform').catch(() => ({ default: () => <div className="w-full h-full bg-slate-900 flex items-center justify-center"><div className="text-white/20 text-6xl font-bold">30</div></div> }))),
  ...
  SlideCleanlinessConditionDashboard: lazy(() => import('./slides/SlideCleanlinessConditionDashboard').catch(() => ({ default: () => <div className="w-full h-full bg-slate-900 flex items-center justify-center"><div className="text-white/20 text-6xl font-bold">44</div></div> }))),
  ...
  SlideFoodSafetyDashboard: lazy(() => import('./slides/SlideFoodSafetyDashboard').catch(() => ({ default: () => <div className="w-full h-full bg-slate-900 flex items-center justify-center"><div className="text-white/20 text-6xl font-bold">45</div></div> }))),
