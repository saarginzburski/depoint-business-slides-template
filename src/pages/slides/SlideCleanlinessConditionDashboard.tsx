...
import dashboardImage from '@/assets/dashboards/Cleanliness & Condition.png';

const SlideCleanlinessConditionDashboard = () => {
    ...
    <SlideLayout
        title={
          <div className="flex items-center gap-4">
            <span>Cleanliness & Condition Dashboard</span>
            <button
        ...
        subtitle="🔒 Protect Revenue – Store Conditions → Brand Trust & Customer Loyalty"
        slideNumber="44"
        totalSlides="44"
        logoSrc={depointLogo}
      ...
      <div className="h-full flex flex-col px-12 pb-8" style={{ gap: '16px' }}>
            ...
            >
              ...
              <div className="flex items-center gap-3 p-3 pl-5">
                ...
                <div className="flex-1">
                  ...
                  >
                    This dashboard protects <span className="font-semibold text-gray-900">brand reputation and customer loyalty</span> through consistent store cleanliness and condition standards
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="flex-1 w-full flex items-center justify-center relative overflow-hidden">
          ...
          <div className="relative w-full h-full flex items-start justify-center overflow-hidden">
            <img
              src={dashboardImage}
              alt="Cleanliness & Condition Dashboard showing store cleanliness standards and facility condition tracking for brand protection"
...
export default SlideCleanlinessConditionDashboard;
