    ...
    <div className="relative w-full h-full">
      ...
      >
        <div className="content-viewport h-full flex flex-col">
          ...
          {/* Hub and Spoke Diagram - Redesigned */}
          <div className="flex-1 flex items-center justify-center">
            <div className="relative w-full max-w-5xl mx-auto">
              
              {/* Central Hub - Depoint with proper white logo */}
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20">
                <div className="w-32 h-32 bg-blue-600 rounded-full flex items-center justify-center shadow-2xl border-4 border-white relative">
                  <img src="/lovable-uploads/96869f4f-a193-4264-973e-1221a0ec5fb9.png" alt="Depoint" className="h-12 object-contain" />
                </div>
              </div>

              {/* Integration Cards positioned around center */}
              <div className="relative w-full h-96">
                
                {/* QuickBooks & ERPs - Top */}
                <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-2">
                  <div className="bg-blue-50 rounded-xl p-4 border border-blue-200 text-center shadow-lg w-36 relative">
                ...
                <div className="absolute top-8 right-8">
                  <div className="bg-green-50 rounded-xl p-4 border border-green-200 text-center shadow-lg w-36 relative">
                    ...
                    {/* Connection line */}
                    <div className="absolute top-1/2 left-0 transform -translate-x-full -translate-y-1/2 w-20 h-0.5 bg-gray-300"></div>
                  </div>
                </div>

                {/* IoT Devices - Bottom Right */}
                <div className="absolute bottom-8 right-8">
                  <div className="bg-orange-50 rounded-xl p-4 border border-orange-200 text-center shadow-lg w-36 relative">
                ...
                <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-2">
                  <div className="bg-purple-50 rounded-xl p-4 border border-purple-200 text-center shadow-lg w-36 relative">
                    <Users className="w-8 h-8 text-purple-600 mx-auto mb-2" />
                    <p className="text-sm font-bold text-purple-800">HR & WFM</p>
                    <p className="text-xs text-purple-600">Platforms</p>
                    {/* Connection line */}
                    <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 w-0.5 h-12 bg-gray-300"></div>
                  </div>
                </div>

                {/* More Integrations - Left */}
                <div className="absolute top-1/2 left-8 transform -translate-y-1/2">
                  <div className="bg-gray-50 rounded-xl p-4 border border-gray-200 text-center shadow-lg w-36 relative">
                    <Zap className="w-8 h-8 text-gray-600 mx-auto mb-2" />
                    <p className="text-sm font-bold text-gray-800">More</p>
                    <p className="text-xs text-gray-600">Coming Soon</p>
                    {/* Connection line */}
                    <div className="absolute top-1/2 right-0 transform translate-x-full -translate-y-1/2 w-20 h-0.5 bg-gray-300"></div>
                  </div>
                </div>
              </div>
            </div>
