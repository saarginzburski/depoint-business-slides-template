...
import managementImage from '@/assets/360mng.png';

const Slide360Management = () => {
  const features = [
    {
      icon: Activity,
      title: "Employee Activity Log:",
      description: "Complete visibility into activities, evaluations, achievements, and performance tracking in real-time.",
      color: "#1E73FF",
    ...
    },
    {
      ...
      description: "All employee data consolidated in one place—from HR systems to operational records.",
      color: "#10B981",
    ...
    },
    {
      ...
      description: "Unified view of every team member across all locations, roles, and performance metrics.",
      color: "#F59E0B",
    ...
    },
    {
      ...
      description: "Role-based access controls ensuring data privacy while maintaining operational transparency.",
      color: "#8B5CF6",
  ...
  return (
    <SlideLayout 
      ...
      totalSlides="40" 
      logoSrc={depointLogo} 
      componentName="Slide360Management"
...
export default Slide360Management;
