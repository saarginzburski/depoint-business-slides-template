...
import dashboardImage from '@/assets/dashboards/Issues Dashboard.png';
...
const SlideIssuesDashboard = () => {
  ...
  return (
    <SlideLayout
        ...
        totalSlides="31"
        logoSrc={depointLogo}
        componentName="SlideIssuesDashboard"
            ...
            >
              ...
              <div className="flex items-center gap-3 p-3 pl-5">
                ...
                <div className="flex-1">
                  ...
                  >
                    This dashboard saves <span className="font-semibold text-gray-900">$280,000+ annually</span> per location by eliminating recurring operational costs
                  </p>
                </div>
              </div>
            </div>
