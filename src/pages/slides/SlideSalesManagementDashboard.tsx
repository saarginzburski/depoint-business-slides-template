...
import dashboardImage from '@/assets/dashboards/Sales Dashboard 2.png';
            ...
            >
              ...
              <div className="flex items-center gap-3 p-3 pl-5">
                ...
                <div className="flex-1">
                  ...
                  >
                    This dashboard drives <span className="font-semibold text-gray-900">$3.5M+ annual revenue growth</span> through sales intelligence optimization
                  </p>
                </div>
              </div>
            </div>
